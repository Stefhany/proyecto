<%-- 
    Document   : cancelarparticipacion
    Created on : 16-nov-2015, 22:27:29
...
<html lang="en">
    <head>
        ...
        <title>Cancelar Aporte - SIGAA</title>
        <!-- Bootstrap Core CSS -->
        ...
        <%
            ...
            if (miSesion.getAttribute("usr") != null) {
                ...
                if (request.getParameter("idAporte") != null) {
                    FacadeAportesProductores facadeAporte = new FacadeAportesProductores();
                    int id = Integer.parseInt(request.getParameter("idAporte"));
                    AportesProductoresDTO aporte = new AportesProductoresDTO();

                    aporte = facadeAporte.consultarMiAporte(id);
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row" style="width:50%;">
                    ...
                    <form action="../cap" method="post" name="modOferta" role="form">

                        <input name="txtIdSolicitud" id="txtIdSolicitud" value="<%if (aporte != null) {
                                out.print(aporte.getSolId().getIdSolicitud());
                            }%>" type="hidden">

                        <input name="txtIdAporte" id="txtIdAporte" value="<%if (aporte != null) {
                                out.print(aporte.getIdAporteProductor());
                            }%>" type="hidden">

                        <div class="form-group">
                            <label for="txtNombreProducto">Nombre del producto:</label>
                            <input name="txtNombreProducto" id="txtNombreProducto" value="<%if (aporte != null) {
                                    out.print(aporte.getSolId().getProduct().getNombre());
                                }%>" type="text" readonly="true" class="form-control">
                        </div>

                        <div class="form-group">
                            <label for="txtCantidadSolicitada">Cantidad solicitada por el distribuidor:</label>
                            <input name="txtCantidadSolicitada" id="txtCantidadSolicitada" value="<%if (aporte != null) {
                                    out.print(aporte.getSolId().getCantidadSolicitada());
                                }%>" type="text" readonly="true" class="form-control">
                        </div>

                        <div class="form-group">
                            <label for="txtUnidad">Unidad:</label>
                            <input name="txtUnidad" id="txtUnidad" value="Kilogramos" type="text" readonly="true" class="form-control">
                        </div>

                        <div class="form-group">
                            <label for="txtFechaEntregaInterna">Fecha de entrega a la asociación:</label>
                            <input name="txtFechaEntregaInterna" id="txtFechaEntregaInterna" value="<%if (aporte != null) {
                                    out.print(aporte.getSolId().getFechaEntregaInterna());
                                }%>" type="text" readonly="true" class="form-control">
                        </div>

                        <div class="form-group">
                            <label for="txtCantidadAportada">Cantidad que aporte:</label>
                            <input name="txtCantidadAportada" id="txtCantidadAportada" value="<%if (aporte != null) {
                                    out.print(aporte.getCantidad());
                        ...
                        <div>
                            <input name="cancelarAporte" id="cancelarAporte" type="hidden">
                            <button name="btnCancelarAporte" id="btnCancelarAporte"
                                    type="submit" class="btn btn-success btn-lg btn-block">Cancelar Aporte</button>
                        </div>
                    </form>
                </div>   
