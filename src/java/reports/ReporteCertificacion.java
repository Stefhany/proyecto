...
public class ReporteCertificacion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (request.getParameter("btnGenerarCertificado") != null && request.getParameter("generarCertificado") != null) {
               ...
               // se recogen los datos del formulario que seran los parametros de la consulta
                ...
                JasperReport subReporte = (JasperReport) JRLoader.loadObject(getServletContext().getRealPath("reports/Certificado_productos.jasper"));
                //se debe crear un map para pasar los parámetros

                Map parametros = new HashMap();
                parametros.put("cedula", dato1);
                parametros.put("Certificado_productos.jasper", subReporte);
            ...
            //En la variable reporte se carga el reporte compilado es decir el jasper
                ...
                JasperReport reporte = (JasperReport) JRLoader.loadObject(getServletContext().getRealPath("reports/Certificado.jasper"));
