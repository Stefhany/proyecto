 ...
 */
public class ReporteCertificado extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (miSesion.getAttribute("usr") != null) {
            ...
            String idUser = uregistrado.getCedula();
            int cedula = Integer.parseInt(idUser);
            Map parametros = new HashMap();
            parametros.put("cedula", cedula);
            parametros.put("logo", getServletContext().getRealPath("jasper/logoFinal.png"));
            parametros.put("firma", getServletContext().getRealPath("jasper/firma.png"));
            parametros.put("subreporte", getServletContext().getRealPath("jasper/CertificadoProductor_productosasociados.jasper"));
            ...
            JasperReport reporte = (JasperReport) JRLoader.loadObject(getServletContext().getRealPath("jasper/CertificadoProductor.jasper"));
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ReporteCertificado.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
