...
public class Prueba extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (request.getParameter("btnConsultar") != null && request.getParameter("btnConsultar").equals("Consultar")) {
               ...
               // se recogen los datos del formulario que seran los parametros de la consulta
                ...
                //String dato1 = request.getParameter("txtCriterio1") != null ? request.getParameter("txtCriterio1") : "0";
                //String dato2 = request.getParameter("txtCriterio2") != null ? request.getParameter("txtCriterio2") : "0";
                //se debe crear un map para pasar los parámetros

                //Map parametros = new HashMap();
                //parametros.put("p1", dato1);
                //parametros.put("p2", dato2);
            ...
            //En la variable reporte se carga el reporte compilado es decir el jasper
                ...
                JasperReport reporte = (JasperReport) JRLoader.loadObject(getServletContext().getRealPath("/reports/report2.jasper"));
            ...
            //La variable bytes toma el reporte jasper le pasa los parámetros y va a la base de datos a traer
                ...
                response.setHeader("Content-Disposition", "attachment; filename=\"reportePrueba" + fecha + ".pdf\"");
